...
function Project() {
  ...
  const images = [
    ...
    '../../images/photo00029.jpg',
    '../../images/photo00030.jpg',
    '../../images/photo00031.jpg',

  ];
  return (
    <div className="w-4/5 mx-auto flex flex-col items-center justify-center min-h-screen p-4">

      <h1 className="text-3xl w-full px-4 py-16 sm:mt-24 lg:mt-42 font-custom2 text-text text-center">Portfolio Showcase</h1>
